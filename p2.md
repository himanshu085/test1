...
|--------------------------------|----------------------------------------------------------------------|-----------------------------------------------------------------|
| Python venv docs               | [Python venv docs](https://docs.python.org/3/library/venv.html)       | Official Python documentation on creating and managing virtual environments using `venv`. |
| Ubuntu package management      | [Ubuntu package management](https://help.ubuntu.com/community/AptGet/Howto) | A comprehensive guide to package management in Ubuntu using `apt-get`. |
